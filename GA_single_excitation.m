function y = GA_single_excitation( nphases,Ham, IN,FIN, np,pe, k, pm, P_infection, Perc_infected,t0,t1,maxit, internal_nodes, weight)
...
%fitness evaluation
        ...
        for i = 1:np
            ...
            fitness_score(i)= 1- abs(U(FIN,IN))^2-weight*sum(abs(U(internal_nodes,IN)).^2);
        end
